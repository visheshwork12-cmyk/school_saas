...
import { BaseException } from '#exceptions/base.exception.js'; // Assume custom exceptions
...
const errorHandler = (err, req, res, next) => {
  ...
  logger.error(`Error: ${message} | Path: ${req.path} | Method: ${req.method} | IP: ${req.ip} | Stack: ${err.stack}`);
